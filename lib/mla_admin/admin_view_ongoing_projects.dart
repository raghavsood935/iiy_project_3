...
class ViewOngoingProjects extends StatefulWidget {
  @override
  State<ViewOngoingProjects> createState() => _ViewOngoingProjectsState();
}

class _ViewOngoingProjectsState extends State<ViewOngoingProjects> {
  ...
  Future<void> _delete(String ref) async {
    ...
    Navigator.pushReplacement(context,
        MaterialPageRoute(builder: (context) => ViewOngoingProjects()));
    setState(() {});
  }
