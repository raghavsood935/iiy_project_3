...
import 'package:flutter_mla_app/mla_admin/admin_view_completed_projects.dart';
import 'package:flutter_mla_app/user/user_model.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:google_fonts/google_fonts.dart';

class AddCompletedProjects extends StatefulWidget {
  @override
  State<AddCompletedProjects> createState() => _AddCompletedProjectsState();
}

class _AddCompletedProjectsState extends State<AddCompletedProjects> {
              ...
              OutlinedButton(
                onPressed: () async {
                  ...
                  try {
                    ...
                    Fluttertoast.showToast(msg: "Successfully Added to Completed Projects");
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ViewCompletedProjects(),
                          ),
                        );
                      },
                      child: ClipRRect(
